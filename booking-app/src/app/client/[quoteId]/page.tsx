...
export default function ClientQuotePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white dark:bg-clio-gray-950 flex items-center justify-center">
        <ModernCard className="text-center p-12 bg-white dark:bg-clio-gray-900 border-clio-gray-200 dark:border-clio-gray-800 shadow-strong rounded-2xl">
          <Loader2 className="w-12 h-12 animate-spin mx-auto mb-6 text-clio-blue" />
          <p className="text-lg font-bold text-clio-gray-900 dark:text-white uppercase tracking-tight">Loading your quote...</p>
        </ModernCard>
      </div>
    );
  }
  ...
  if (accessDenied) {
    return (
      <div className="min-h-screen bg-white dark:bg-clio-gray-950 flex items-center justify-center">
        <ModernCard className="max-w-md mx-auto text-center p-12 bg-white dark:bg-clio-gray-900 border-clio-gray-200 dark:border-clio-gray-800 shadow-strong rounded-2xl">
          ...
          <h1 className="text-2xl font-bold text-clio-gray-900 dark:text-white mb-3 uppercase tracking-tight">Access Denied</h1>
          <p className="text-clio-gray-600 dark:text-clio-gray-400 font-medium mb-6">
            You don&apos;t have permission to view this quote. Please check your link or contact your travel agent.
          </p>
          <div className="text-[10px] font-black text-clio-gray-400 uppercase tracking-widest border-t border-clio-gray-100 dark:border-clio-gray-800 pt-6">
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-clio-gray-950 flex items-center justify-center">
        <ModernCard className="max-w-md mx-auto text-center p-12 bg-white dark:bg-clio-gray-900 border-clio-gray-200 dark:border-clio-gray-800 shadow-strong rounded-2xl">
          ...
          <h1 className="text-2xl font-bold text-clio-gray-900 dark:text-white mb-3 uppercase tracking-tight">Quote Not Found</h1>
          <p className="text-clio-gray-600 dark:text-clio-gray-400 font-medium mb-6">
