...
export const CommissionModal: React.FC<CommissionModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden p-0 border-none shadow-strong bg-white dark:bg-clio-gray-900">
        <DialogHeader className="flex flex-row items-center justify-between p-8 border-b border-clio-gray-100 dark:border-clio-gray-800 bg-clio-gray-50/50 dark:bg-clio-gray-900/50">
          <div>
            ...
            <p className="text-[10px] font-black text-clio-gray-400 uppercase tracking-widest mt-1">Review and manage agent commission</p>
          </div>
